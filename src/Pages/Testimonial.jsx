  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="max-w-4xl text-center">
        ...
        <h4 className="text-base md:text-sm text-black leading-relaxed">
          Sayar Jewellers portrays the medley of traditions and contemporary taste that form the legacy we cherish and share today. Take a peek at what our loyal customers have to say, as we feel heartened by their trust in our jewellery to uphold their roots.
        </h4>
      </div>
